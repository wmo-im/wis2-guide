...
** If the record is missing from one or more GDCs, the SCGDC will increase the metric ``wmo_wis2_scgdc_records_incorrect_total`` by ``1`` for all GDCs missing the record.
