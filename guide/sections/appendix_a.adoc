...
The proportion of time that the Global Broker's MQTT endpoint is accessible, published by the Sensor Centre Global Broker using metric `wmo_wis2_scgb_connected_flag`.
