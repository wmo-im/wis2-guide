...
[%header,format=csv]
|===
include::https://raw.githubusercontent.com/wmo-im/wis2-metric-hierarchy/blob/main/metric-hierarchy/gb.csv[]
|===
...
[%header,format=csv]
|===
include::https://github.com/wmo-im/wis2-metric-hierarchy/blob/main/metric-hierarchy/gc.csv[]
|===
See footnote:wmo-wmh[] for further details.
...
[%header,format=csv]
|===
include::https://github.com/wmo-im/wis2-metric-hierarchy/blob/main/metric-hierarchy/gdc.csv[]
|===
See footnote:wmo-wmh[] for further details.
...
[%header,format=csv]
|===
include::https://github.com/wmo-im/wis2-metric-hierarchy/blob/main/metric-hierarchy/sensor.csv[]
|===
See footnote:wmo-wmh[] for further details.
