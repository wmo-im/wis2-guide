...
* Complete the WIS Registry: The WIS national focal point shall complete the WIS registry operated by the WMO Secretariat 
* WIS2 Node assessment: the principal GISC verifies that the WIS2 Node is compliant with WIS 2.0 requirements. The assessment includes: 
  - the verification of the compliance of the topic hierarchy (TH) used by the centre with the agreed topic hierarchy. 
