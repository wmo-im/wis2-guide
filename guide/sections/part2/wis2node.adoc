...
A WIS2 Node can act as a publication facility on behalf of other centres. This is a Data Collection role, as defined in the Manual on WIS. Data or metadata publication by a Data Collection role will use the centre identifiers of the data producers.
