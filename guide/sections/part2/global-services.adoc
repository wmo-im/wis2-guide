...
* A Global Cache will emit the following metrics foreach WIS2 component (e.g., WIS2 Node or other Global Cache, identified with its ``centre-id``) from which it attempts to download and cache resources (e.g., data objects or metadata records): 
