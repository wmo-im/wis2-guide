...
* A Global Broker will validate monitoring events against the standard format (see _Manual on WIS_, Volume II – Appendix G. WIS2 Monitoring Events), discarding non-compliant messages and raising an alert. The metric ``wmo_wis2_gb_invalid_format_total`` will be increased by 1.
