...
* The metric ``wmo_wis2_gc_last_metadata_timestamp_seconds`` will reflect the datetime (as a timestamp, the number of seconds since the epoch) of the last metadata resource processed by a given centre.
