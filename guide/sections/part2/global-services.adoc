...
* Any Global Service operator anticipating an outage that may exceed 4 hours should raise a ticket in the WMO JIRA ticketing system. The "maintenance" template should be used for the ticket.
* A Global Broker:
