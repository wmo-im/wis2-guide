...
** When a Global Cache receives a motification message with the ``properties.cache`` object set to false, it will not attempt to cache the resource referred to in that notification message.
