...
* A Global Discovery Catalogue shall generate and publish a zipfile of all WCMP2 records once a day to an HTTP accessible location to its `+metadata+` topic.  The link to the archive metadata shall additionally be made available as an archive link on the landing page of the GDC.
