...
The principles of information management are described below. Section <<_4_3_the_information_management_life_cycle>> describes five focus areas.
...
For non-standard and specialist products, targeted user guides may be more appropriate. These should be accessible and retrievable via a link within the discovery metadata and should include a plain text summary for the non-technical user. Any user guide should be in addition to the technical documentation described in <<_4_3_3_1_planning_information_creation_and_acquisition>>.
